...
const Timeline: React.FC<TimelineProps> = ({ channels, duration, config, currentTime, onScrub }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-zinc-900 rounded-lg overflow-hidden border border-zinc-800 relative">
      <div className="h-8 flex items-center justify-between px-4 bg-zinc-800 border-b border-zinc-700 flex-shrink-0 z-10">
      ...
      <div className="flex-1 relative w-full min-h-0">
        ...
        {/* Playhead Overlay Click Capture */}
        <div 
